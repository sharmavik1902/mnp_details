...
data = {
    "Date": ["2025-03-01", "2025-03-05", "2025-03-10", "2025-04-01"],
    "Equipment": ["Crusher 1", "Crusher 2", "Belt 3", "Crusher 2"],
    "Status": ["Reported", "Resolved", "Reported", "Reported"],
    "Defect": ["Vibration", "Oil Leak", "Belt Tear", "Motor Trip"]
}
